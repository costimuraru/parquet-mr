...
//
//        System.out.println(formatter.toAthenaSql(message, "cmuraru21", "s3://cmuraru-analytics/athena/test21/"));
//
//    }

  public static void main(String[] args) throws IOException {
    Message message = ListOfListOuterClass.ListOfList.getDefaultInstance();
    ProtoToAthena formatter = new ProtoToAthena();

    System.out.println(formatter.toAthenaSql(message, "cmuraru23", "s3://cmuraru-analytics/athena/test23/"));
